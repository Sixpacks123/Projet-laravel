...
async function loadWithNodejs(outDir) {
    const cwd = (0, utils_1.getCwd)();
    if (!cwd)
        return false;
    let path;
    ...
    try {
        distImporterPath = await (0, utils_1.requireResolve)(distImporterPathUnresolved, __filename);
    }
    catch (_b) {
        (0, utils_1.assert)(!fs.existsSync(distImporterDir), { distImporterDir, distImporterPathUnresolved });
        return false;
    }
