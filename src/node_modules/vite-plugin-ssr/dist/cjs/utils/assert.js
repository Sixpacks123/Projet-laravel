...
function assert(condition, debugInfo) {
    ...
    const debugStr = (() => {
        ...
        return picocolors_1.default.dim(`Debug info (this is for the ${projectInfo_js_1.projectInfo.projectName} maintainers; you can ignore this): ${debugInfoSerialized}`);
    })();
