...
const virtualFileImportPageCode_js_1 = require("../../../../shared/virtual-files/virtualFileImportPageCode.js");
const debug_js_1 = require("./debug.js");
const stringify_1 = require("@brillout/json-serializer/stringify");
const getVirtualFileImportCodeFiles_js_1 = require("./getVirtualFileImportCodeFiles.js");
const helpers_js_1 = require("./helpers.js");
const picocolors_1 = __importDefault(require("@brillout/picocolors"));
function serializePageConfigs(pageConfigs, pageConfigGlobal, isForClientSide, isDev, id, isClientRouting) {
    const lines = [];
    ...
    pageConfigs.forEach((pageConfig) => {
        ...
        const virtualFileIdImportPageCode = (0, virtualFileImportPageCode_js_1.getVirtualFileIdImportPageCode)(pageId, isForClientSide);
        lines.push(`  {`);
        ...
        Object.entries(pageConfig.configValueSources).forEach(([configName, sources]) => {
            ...
            if (configValue) {
                ...
                if ((0, getVirtualFileImportCodeFiles_js_1.skipConfigValue)(configEnv, isForClientSide, isClientRouting))
                    return;
...
function serializeConfigValueSource(configValueSource, configName, whitespace, isForClientSide, isClientRouting, importStatements, isGlobalConfig) {
    ...
    if (!(0, getVirtualFileImportCodeFiles_js_1.skipConfigValue)(configEnv, isForClientSide, isClientRouting) || eager) {
...
function getConfigValueEagerImport(codeFilePath, codeFileExport, importStatements) {
    let configValueEagerImport;
    const { importVar, importStatement } = (0, generateEagerImport_js_1.generateEagerImport)(codeFilePath);
