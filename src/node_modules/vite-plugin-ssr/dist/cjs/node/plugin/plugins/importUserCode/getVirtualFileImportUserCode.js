...
const getVirtualFileImportPageConfigs_js_1 = require("./v1-design/getVirtualFileImportPageConfigs.js");
...
${await (0, getVirtualFileImportPageConfigs_js_1.getVirtualFileImportPageConfigs)(config.root, isForClientSide, isDev, id, configVps, isClientRouting)}
