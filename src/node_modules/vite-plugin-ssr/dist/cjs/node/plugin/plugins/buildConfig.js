        ...
        config(config) {
            return {
                build: {
                    ...
                    manifest: !(0, utils_js_1.viteIsSSR)(config),
...
async function getEntries(config) {
    ...
    const { pageConfigs: pageConfigsData } = await (0, getVikeConfig_js_1.getVikeConfig)(config.root, false, configVps.extensions);
    (0, utils_js_1.assertUsage)(Object.keys(pageFileEntries).length !== 0 || pageConfigsData.length !== 0, 'At least one page should be defined, see https://vite-plugin-ssr.com/add');
...
function getEntryFromPageConfig(pageConfig, isForClientSide) {
    ...
    const entryTarget = (0, virtualFileImportPageCode_js_1.getVirtualFileIdImportPageCode)(pageId, isForClientSide);
