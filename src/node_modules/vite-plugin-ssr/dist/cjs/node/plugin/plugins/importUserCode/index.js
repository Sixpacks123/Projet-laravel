...
const getVirtualFileImportCodeFiles_js_1 = require("./v1-design/getVirtualFileImportCodeFiles.js");
...
function importUserCode() {
    ...
    return {
        ...
        async load(id, options) {
            ...
            if ((0, virtualFileImportPageCode_js_1.isVirtualFileIdImportPageCode)(id)) {
                const code = await (0, getVirtualFileImportCodeFiles_js_1.getVirtualFileImportCodeFiles)(id, config.root, isDev, configVps);
                return code;
            }
...
function getVirtualModules(server) {
    const virtualModules = Array.from(server.moduleGraph.urlToModuleMap.keys())
        .filter((url) => (0, virtualFileImportPageCode_js_1.isVirtualFileIdImportPageCode)(url) || (0, virtualFileImportUserCode_js_1.isVirtualFileIdImportUserCode)(url))
        .map((url) => {
