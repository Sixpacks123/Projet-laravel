...
function analyzePage(pageFilesAll, pageConfig, pageId) {
    if (pageConfig) {
        ...
        clientDependencies.push({
            id: (0, virtualFileImportPageCode_js_1.getVirtualFileIdImportPageCode)(pageConfig.pageId, true),
            onlyAssets: false,
        ...
        if (!(0, globalContext_js_1.getGlobalContext)().isProduction) {
            clientDependencies.push({
                id: (0, virtualFileImportPageCode_js_1.getVirtualFileIdImportPageCode)(pageConfig.pageId, false),
                onlyAssets: true,
                eagerlyImported: false
            });
        }
