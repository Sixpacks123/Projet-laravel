 ...
 */
declare function render(abortStatusCode: 401 | 403 | 404 | 410 | 429 | 500 | 503, abortReason?: unknown): Error;
/**
 ...
 * @param abortReason Sets `pageContext.abortReason` which is used by the error page to show a message to the user, see https://vite-plugin-ssr.com/error-page
 */
declare function render(url: `/${string}`, abortReason?: unknown): Error;
