 ...
 * https://vite-plugin-ssr.com/pageContext
 */
type PageContextBuiltInClientWithClientRouting<Page = any> = Partial<PageContextBuiltInCommon<Page>> & Pick<PageContextBuiltInCommon<Page>, 'Page' | 'pageExports' | 'config' | 'configEntries' | 'exports' | 'exportsAll' | 'abortReason'> & {
 ...
 * https://vite-plugin-ssr.com/pageContext
 */
type PageContextBuiltInClientWithServerRouting<Page = any> = Partial<PageContextBuiltInCommon<Page>> & Pick<PageContextBuiltInCommon<Page>, 'Page' | 'pageExports' | 'exports' | 'abortReason'> & {
    /**
     * Whether the current page is already rendered to HTML.
     *
